...
class VisitorActivity : AppCompatActivity(), GLSurfaceView.Renderer, TextToSpeech.OnInitListener {
    ...
    private fun loadWaypoints() {
        ...
        if (waypoints.isEmpty()) {
            tvAvailableLocations.text = "⚠ No locations mapped yet. Use Host mode first."
    ...
    private fun processVoiceCommand(command: String) {
        ...
        if (matchedWaypoint != null) {
            ...
            runOnUiThread {
                tvDestination.text = "→ Destination: ${matchedWaypoint.name}"
        ...
        try {
            ...
            currentDestination?.let { dest ->
                ...
                runOnUiThread {
                    ...
                    tvDirection.text = directionText  // ← THIS IS THE NEW LINE
                    tvDirection.visibility = TextView.VISIBLE  // ← AND THIS ONE
                    ...
                    if (navInfo.distance < 1.0f) {
                        ...
                        tvDirection.visibility = TextView.GONE  // ← ADD THIS TOO
